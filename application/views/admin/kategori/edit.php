...
<head>
    ...
    <style>
        /* SAMA PERSIS dengan desain Edit Produk */
        :root {
            --cream-bg: #F8F4EA;
            --cream-card: #FFFDF6;
            --blue-light: #E3F2FD;
        ...
        /* Header Styling - SAMA dengan Edit Produk */
        h3 {
            color: var(--blue-dark);
            font-weight: 800;
            margin-bottom: 30px;
        ...
        /* Form Container - SAMA dengan Edit Produk */
        .form-container {
        ...
        /* Form Group Styling - SAMA dengan Edit Produk */
        .form-group {
            margin-bottom: 25px;
            position: relative;
        }
        ...
        /* Form Controls - SAMA dengan Edit Produk */
        .form-control {
        ...
        /* Button Container - SAMA dengan Edit Produk */
        .button-container {
            display: flex;
            gap: 15px;
            margin-top: 40px;
        ...
        /* Button Styling - SAMA PERSIS dengan Edit Produk */
        .btn {
            padding: 14px 28px;
            border-radius: 12px;
            font-weight: 700;
        ...
        /* Validation Styling - SAMA dengan Edit Produk */
        .is-invalid {
        ...
        /* Required field indicator - SAMA dengan Edit Produk */
        ...
        /* Responsive Design - SAMA dengan Edit Produk */
        ...
        /* Animation - SAMA dengan Edit Produk */
        @keyframes fadeIn {
            from {
                opacity: 0;
        ...
        /* Card Effect - SAMA dengan Edit Produk */
        .container::before {
            content: '';
            position: absolute;
            top: 0;
        ...
        /* Success Message - SAMA dengan Edit Produk */
        .alert-success {
        ...
        /* Changed Field Highlight - SAMA dengan Edit Produk */
        .field-changed {
...
<div class="container mt-4">
    ...
    <div class="form-container">
        <form action="<?= base_url('admin/kategori/update/'.$kategori->id_kategori) ?>" method="post" id="editForm">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const input = document.getElementById('namaKategoriInput');
    const successMessage = document.getElementById('successMessage');
    
    // Simpan nilai awal untuk deteksi perubahan
    const originalValue = input.value.trim();
    
    // Real-time validation - SAMA dengan Edit Produk
    if(input) {
    ...
    // Deteksi perubahan input - SAMA dengan Edit Produk
    ...
    // Form submission - SAMA dengan Edit Produk
    form.addEventListener('submit', function(e) {
        ...
        setTimeout(() => {
            ...
            // Reset changed state setelah berhasil
            input.classList.remove('field-changed');
        }, 500);
    });
    
    // Input character counter (optional) - SAMA dengan Edit Produk
    const charCounter = document.createElement('div');
    charCounter.className = 'char-counter text-muted mt-2';
    charCounter.style.fontSize = '0.85rem';
    charCounter.innerHTML = 'Jumlah karakter: <span id="charCount">' + originalValue.length + '</span>';
